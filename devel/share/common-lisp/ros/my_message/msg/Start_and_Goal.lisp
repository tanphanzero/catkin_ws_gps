...
(cl:defmethod cl:initialize-instance :after ((m <Start_and_Goal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Start_and_Goal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_message-msg:<Start_and_Goal> is deprecated: use my_message-msg:Start_and_Goal instead.")))

(cl:ensure-generic-function 'robot_x-val :lambda-list '(m))
(cl:defmethod robot_x-val ((m <Start_and_Goal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_message-msg:robot_x-val is deprecated.  Use my_message-msg:robot_x instead.")
  (robot_x m))

(cl:ensure-generic-function 'robot_y-val :lambda-list '(m))
(cl:defmethod robot_y-val ((m <Start_and_Goal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_message-msg:robot_y-val is deprecated.  Use my_message-msg:robot_y instead.")
  (robot_y m))

(cl:ensure-generic-function 'clicked_x-val :lambda-list '(m))
(cl:defmethod clicked_x-val ((m <Start_and_Goal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_message-msg:clicked_x-val is deprecated.  Use my_message-msg:clicked_x instead.")
  (clicked_x m))

(cl:ensure-generic-function 'clicked_y-val :lambda-list '(m))
(cl:defmethod clicked_y-val ((m <Start_and_Goal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_message-msg:clicked_y-val is deprecated.  Use my_message-msg:clicked_y instead.")
  (clicked_y m))
